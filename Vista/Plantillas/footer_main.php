<footer class="container-fluid bg-ownDark mt-5 text-light">
    <h2 class="text-white d-none">Pie de páina</h2>
    <div class="row justify-content-center align-items-center p-4">
        <div class="row">
            <div class="col-12 col-md-4">
                <a href="galeria" class="text-decoration-none text-light"><h3>Género</h3></a>
            </div>
            <div class="d-none d-md-block col-4">
                <a href="contacto" class="text-decoration-none text-light"><h3>Contacto</h3></a>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-4 d-flex text-white">
                <ul id="footer_genero">
            ...
            <div class="col-12 col-md-4">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-6">
                        <a class="text-decoration-none text-light" href="tel:+34666666666">666 666 666</a>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-2">
                    ...
                    <div class="col-6">
                        <a class="text-decoration-none text-light" href="mailto:ebook.soporte@gmail.com">ebook.soporte@gmail.com</a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <a href="https://es-es.facebook.com/">
                            <p class="d-none text-white">Facebook</p>
                            <svg enable-background="new 0 0 1024 1024" viewBox="0 0 1500 1500" xmlns="http://www.w3.org/2000/svg" height="50" width="50">
                    ...
                    <div class="col-4">
                        <a href="https://www.instagram.com/">
                            <p class="d-none text-white">Instagram</p>
                            <svg fill="none" height="50" viewBox="0 0 120 120" width="50"   xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/  xlink">
                                <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="89.802" x2="-1.75982" y1="91.5618" y2="-.000002">
            ...
            <div class="col-12 col-md-4">
                <ol><a href="politica-privacidad" class="text-decoration-none text-light">Política de   privacidad</a></ol>
                <ol><a href="aviso-legal" class="text-decoration-none text-light">Aviso legal</a></ol>
                <ol><a href="cookies" class="text-decoration-none text-light">Cookies</a></ol>
            </div>
        </div>
    </div>
